...
interface CalendarSidebarProps {
  ...
  onStatusChange?: (eventId: string, newStatus: 'pendente' | 'confirmado' | 'concluido') => void
}
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-[#727B8E] dark:text-[#8a94a6]">{event.type}</p>
                    <p className="text-xs text-[#727B8E] dark:text-[#8a94a6]">{event.time}</p>
