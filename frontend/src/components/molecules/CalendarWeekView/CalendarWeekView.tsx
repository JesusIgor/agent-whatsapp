...
const STATUS_BG: Record<AppointmentStatus, string> = {
  concluido: 'bg-[#EAFBEB] border-l-[#3CD057] dark:bg-[#1e3d22] dark:border-l-[#3CD057]',
  confirmado: 'bg-[#EBF1FB] border-l-[#3C6BD0] dark:bg-[#1e2d4a] dark:border-l-[#3C6BD0]',
  pendente: 'bg-[#FBFBEB] border-l-[#D0B33C] dark:bg-[#3d381e] dark:border-l-[#D0B33C]',
}
